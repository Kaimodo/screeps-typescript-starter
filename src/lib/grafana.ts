...
class GrafanaClass {
  ...
  private init(room: Room, object: GrafanaMemory) {
  ...
  private controller(room: Room, object: GrafanaMemory) {
    if (room.controller) {
      object.controller = {
  ...
  private energy(room: Room, object: GrafanaMemory) {
    object.energy = {
  ...
  private storage(room: Room, object: GrafanaMemory) {
  ...
  private terminal(room: Room, object: GrafanaMemory) {
